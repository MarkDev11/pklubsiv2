<x-app-layout>
    ...
    <div class="space-y-6 animate-fade-in">
        <div class="card !p-0 overflow-hidden border border-gray-200 dark:border-surface-700">
            ...
            {{-- Header --}}
            <div class="bg-gradient-to-r from-emerald-600 to-teal-700 px-6 py-8 relative">
                <div class="flex items-center justify-between relative z-10">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-white tracking-tight">Nilai Program MSIB / PMK</h3>
                            <p class="text-emerald-100 text-sm mt-0.5 flex items-center gap-2">
                ...
                <div class="absolute right-20 -bottom-8 w-28 h-28 bg-emerald-400/20 rounded-full blur-xl"></div>
            </div>
            ...
            <div class="p-6">
                ...
                <form method="POST" action="{{ route(str_contains(request()->route()->getName(), 'admin') ? 'admin.nilai.save' : (str_contains(request()->route()->getName(), 'dosen') ? 'dosen.nilai.save' : 'mentor.nilai.save')) }}">
                    ...
                    <div class="table-container rounded-xl border border-gray-200 dark:border-surface-700">
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-gray-100 dark:divide-surface-700">
                                ...
                                <tr class="hover:bg-emerald-50/50 dark:hover:bg-surface-800/80 transition-colors">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="relative inline-block w-20">
                                            <input type="number" name="nilai[]" value="{{ $p->nilai }}" min="0" max="100"
                                                class="form-input w-full text-center py-2 pr-2 font-bold text-lg focus:ring-emerald-500 focus:border-emerald-500 {{ $p->nilai > 0 ? 'bg-emerald-50 border-emerald-300 dark:bg-emerald-900/20 dark:border-emerald-700 text-emerald-700 dark:text-emerald-400' : 'bg-white dark:bg-surface-800 border-gray-300 dark:border-surface-600' }}">
                                        </div>
                                    </td>
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-center mt-6 gap-4 border-t border-gray-100 dark:border-surface-700 pt-6">
                        ...
                        <button type="submit" class="btn-success hover:-translate-y-1 transition-transform shadow-lg shadow-emerald-500/30 px-8 py-2.5 rounded-xl flex items-center gap-2">
                ...
                <div class="text-center py-16 px-4">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 max-w-sm mx-auto">Saat ini belum ada mahasiswa jalur MSIB/PMK yang dapat dinilai.</p>
                </div>
                @endif
            </div>

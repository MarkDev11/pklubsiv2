...
class DosenMentorSheet implements FromArray, WithHeadings, WithTitle, WithStyles
{
    public function array(): array
    {
        return [
            ...
            [8, 'Mahasiswa Data Dosen', 'Lihat mahasiswa PKL yang dibimbing', 'Tabel menampilkan mahasiswa PKL sesuai nama_dosen_pa', 'Sesuai harapan', 'Berhasil'],
            [9, 'Mahasiswa Data Dosen', 'Lihat mahasiswa MSIB yang dibimbing', 'Tabel menampilkan mahasiswa MSIB sesuai nama_dosen_pa', 'Sesuai harapan', 'Berhasil'],

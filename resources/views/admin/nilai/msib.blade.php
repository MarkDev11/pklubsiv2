<x-app-layout>
    <x-slot name="title">Nilai MSIB / PMK</x-slot>
    
    <div class="space-y-6">
        
        {{-- Header --}}
        <div>
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Nilai Program MSIB / PMK</h1>
        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
            <form method="GET" action="{{ route(request()->route()->getName()) }}" 
                ...
                <div class="flex-1">
                    <div class="relative">
                        ...
                        <input type="text" name="search" x-model="search" 
                               ...
                               placeholder="Cari nama, NIM, mitra industri, atau mentor..."
                               class="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-900 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm">
                    </div>
                </div>
                
                {{-- Filter Kelengkapan --}}
                <div class="w-full lg:w-48">
                    <select name="kelengkapan" @change="submitForm()" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm">
                ...
                {{-- Filter Status Nilai --}}
                <div class="w-full lg:w-48">
                    <select name="status_nilai" @change="submitForm()" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm">
        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
                                ...
                                <th class="px-4 py-3 text-left font-medium text-gray-600 dark:text-gray-400 uppercase text-xs tracking-wider">Mitra Industri & Mentor</th>
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                                ...
                                <td class="px-4 py-3">
                                    ...
                                    <div class="font-mono text-xs text-emerald-600 dark:text-emerald-400 mt-0.5">{{ $p->nim }}</div>
                                </td>
                                    ...
                                    <div class="relative w-24 mx-auto">
                                        <input type="number" name="nilai[]" x-model="nilai" min="75" max="100" step="1"
                                               ...
                                               :class="{
                                                   ...
                                                   'border-gray-300 dark:border-gray-600 focus:border-emerald-500 focus:ring-emerald-500': status === 'idle'
                                               }"
            ...
            <div class="p-12 text-center">
                ...
                <p class="text-gray-500 dark:text-gray-400 font-medium">Belum ada mahasiswa MSIB/PMK yang terdaftar</p>
            </div>
            @endif
        </div>

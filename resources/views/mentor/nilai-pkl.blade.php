        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
            ...
            @else
                <div class="p-12 text-center">
                    ...
                    <p class="text-gray-500 dark:text-gray-400 font-medium">Belum ada mahasiswa Magang yang didaftarkan untuk perusahaan Anda.</p>
                </div>
            @endif
        </div>

        @include('partials.scoped-export-panel', [
            'exportAction' => route('mentor.exports.pkl'),
            'exportCategory' => 'pkl',

<x-app-layout>
    <x-slot name="title">Penilaian MSIB</x-slot>
    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Input Nilai MSIB / PMK</h1>
        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
            <form method="GET" action="{{ route('mentor.nilai.msib') }}"
                  x-data="{
                ...
                <div class="flex-1">
                    <div class="relative">
                        ...
                        <input type="text" name="search" x-model="search"
                               ...
                               placeholder="Cari nama, NIM, atau mitra industri..."
                ...
                @if(request()->hasAny(['search', 'kelengkapan', 'status_nilai']))
                    <a href="{{ route('mentor.nilai.msib') }}" class="px-4 py-2 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-md transition-colors flex items-center gap-2">
        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
                                ...
                                <th class="px-4 py-3 text-left font-medium text-gray-600 dark:text-gray-400 uppercase text-xs tracking-wider">Mitra Industri</th>
            ...
            @else
                <div class="p-12 text-center">
                    ...
                    <p class="text-gray-500 dark:text-gray-400 font-medium">Belum ada mahasiswa MSIB/PMK yang didaftarkan untuk perusahaan Anda.</p>
                </div>
            @endif
        </div>

        @include('partials.scoped-export-panel', [
            'exportAction' => route('mentor.exports.msib'),
            'exportCategory' => 'msib',

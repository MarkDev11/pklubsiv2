<x-app-layout>
    ...
    <div class="space-y-6" x-data="{
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-3">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Mahasiswa Bimbingan MSIB / PMK</h1>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Daftar peserta MSIB / Kampus Merdeka di bawah bimbingan teknis Anda.</p>
            </div>
                        ...
                        <tr>
                            <td colspan="5">
                                <div class="p-12 text-center">
                                    ...
                                    <p class="text-gray-500 dark:text-gray-400 font-medium">Tidak ada mahasiswa MSIB yang sedang berjalan.</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse

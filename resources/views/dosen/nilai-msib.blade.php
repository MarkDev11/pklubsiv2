<x-app-layout>
    <x-slot name="title">Verifikasi Nilai MSIB</x-slot>
    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Verifikasi Nilai MSIB / PMK</h1>
        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
            <form method="GET" action="{{ route('dosen.nilai.msib') }}"
                ...
                <div class="flex-1">
                    <div class="relative">
                        ...
                        <input type="text" name="search" x-model="search"
                               ...
                               placeholder="Cari nama, NIM, mitra, atau mentor..."
                ...
                @if(request()->hasAny(['search', 'kelengkapan', 'status_nilai']))
                    <a href="{{ route('dosen.nilai.msib') }}" class="px-4 py-2 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-md transition-colors flex items-center gap-2">
        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
            ...
            @else
                <div class="p-12 text-center">
                    ...
                    <p class="text-gray-500 dark:text-gray-400 font-medium">Belum ada mahasiswa MSIB/PMK yang dibimbing.</p>
                </div>
            @endif
        </div>

<x-app-layout>
    ...
    <div class="space-y-6" x-data="{
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Daftar mahasiswa bimbingan program Kampus Merdeka MSIB.</p>
        </div>
        ...
        <div class="flex flex-col sm:flex-row justify-between gap-3">
            ...
            <a href="{{ route('dosen.pdf.msib') }}" target="_blank"

<x-app-layout>
    ...
    <div class="space-y-6 animate-fade-in pb-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
            <div class="bg-white dark:bg-surface-800 rounded-2xl p-5 shadow-sm border border-gray-100 dark:border-surface-700 flex items-center gap-4">
        ...
        <div class="bg-white dark:bg-surface-800 rounded-[2rem] shadow-sm border border-gray-100 dark:border-surface-700 overflow-hidden relative">
                        ...
                        <tr class="hover:bg-gray-50/50 dark:hover:bg-surface-800/50 transition-colors group">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <div class="flex items-center gap-2">
                                    <div class="w-6 h-6 rounded-md bg-gray-100 dark:bg-surface-700 flex items-center justify-center shrink-0">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <button onclick="document.getElementById('modal-{{ $log->id }}').classList.remove('hidden')" class="w-8 h-8 rounded-lg bg-gray-100 dark:bg-surface-700 text-gray-600 hover:text-indigo-600 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 flex items-center justify-center transition-colors" title="Lihat Detail Stack Trace">
                                        <i class="fa-solid fa-eye text-xs"></i>
                                    </button>
                                    <form action="{{ route('admin.logs.error.destroy', $log->id) }}" method="POST" onsubmit="return confirm('Hapus log ini?')">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="w-8 h-8 rounded-lg bg-gray-100 dark:bg-surface-700 text-gray-600 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/30 flex items-center justify-center transition-colors" title="Hapus Log">
                        ...
                        <div id="modal-{{ $log->id }}" class="fixed inset-0 z-50 hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                            ...
                            <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                                <div class="flex min-h-full items-center justify-center p-4 sm:p-0">
                                    <div class="relative transform overflow-hidden rounded-2xl bg-white dark:bg-surface-800 text-left shadow-xl transition-all sm:my-8 w-full max-w-4xl border border-gray-100 dark:border-surface-700">
                                        
                                        <div class="bg-gray-50 dark:bg-surface-900 px-6 py-4 border-b border-gray-100 dark:border-surface-700 flex items-center justify-between">
                                        ...
                                        <div class="px-6 py-5 space-y-6">
                                            ...
                                            <div>
                                                <p class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-1 flex items-center justify-between">
                                                    ...
                                                    <span class="text-[10px] bg-gray-200 dark:bg-surface-700 px-2 py-0.5 rounded font-mono">{{ basename($log->file) }}:{{ $log->line }}</span>
                                                </p>
                                            ...
                                            <div>
                                                ...
                                                <div class="bg-gray-50 dark:bg-surface-900 rounded-xl p-4 border border-gray-200 dark:border-surface-700 overflow-x-auto">
            ...
            <div class="p-4 border-t border-gray-100 dark:border-surface-700 bg-gray-50/50 dark:bg-surface-850/20">
                {{ $logs->links() }}
            </div>
        </div>
